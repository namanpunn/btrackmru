...
const Tracking = () => {
  return (
    <div>
      <section className="flex bg-[#FDD51A] h-28 px-7 items-center font-extrabold p-4">
        {/* Next Image */}
        <div className="mr-4">
          <img
            src="images/next.png"
      ...
      <section className="w-full">
        ...
        ></iframe>
        <img src="images/bus2.png" alt="" className="z-50 h-8 w-12 relative -top-28 left-20" />
      </section>


      <section className="bg-slate-100 -mt-8 h-96 p-5 flex flex-col gap-6 rounded-lg shadow-md">
